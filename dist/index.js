...
var DIFactory = /** @class */ (function () {
    ...
    DIFactory.register = function (registration) {
        DependencyInjector_1.__dInjector.register(registration);
    };
    DIFactory.registerMultiple = function (registrations) {
        DependencyInjector_1.__dInjector.registerMultiple(registrations);
    };
    ...
    constructor_arguments_that_come_after_the_dependencies) {
        ...
        var factory = DependencyInjector_1.__dInjector.getFactory(TheClass);
